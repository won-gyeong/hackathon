const kakao = {
  SPEL: { id: 0, name: "SPEL", link: "https://open.kakao.com/o/g4ctxolf" },
  SPEF: { id: 1, name: "SPEF", link: "https://open.kakao.com/o/gnCRyolf" },
  SPUL: { id: 2, name: "SPUL", link: "https://open.kakao.com/o/gULjAolf" },
  SPUF: { id: 3, name: "SPUF", link: "https://open.kakao.com/o/gVK3Aolf" },
  SCEL: { id: 4, name: "SCEL", link: "https://open.kakao.com/o/geeTColf" },
  SCEF: { id: 5, name: "SCEF", link: "https://open.kakao.com/o/gHltDolf" },
  SCUL: { id: 6, name: "SCUL", link: "https://open.kakao.com/o/gYsXDolf" },
  SCUF: { id: 7, name: "SCUF", link: "https://open.kakao.com/o/gnWmFolf" },
  APEL: { id: 8, name: "APEL", link: "https://open.kakao.com/o/gnpcvolf" },
  APEF: { id: 9, name: "APEF", link: "https://open.kakao.com/o/g8Oywolf" },
  APUL: { id: 10, name: "APUL", link: "https://open.kakao.com/o/gtpExolf" },
  APUF: { id: 11, name: "APUF", link: "https://open.kakao.com/o/gEMZzolf" },
  APUL: { id: 10, name: "APUL", link: "https://open.kakao.com/o/gtpExolf" },
  ACEL: { id: 12, name: "ACEL", link: "https://open.kakao.com/o/geeTColf" },
  ACEF: { id: 13, name: "ACEF", link: "https://open.kakao.com/o/geeTColf" },
  ACUL: { id: 14, name: "ACUL", link: "https://open.kakao.com/o/geeTColf" },
  ACUF: { id: 15, name: "ACUF", link: "https://open.kakao.com/o/gufQnplf" },
};
